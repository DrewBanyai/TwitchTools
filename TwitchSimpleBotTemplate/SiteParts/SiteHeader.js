class SiteHeader {
    ...
    async loadSiteNameBox(container) {
        let siteTitleLabel = new Label({ id: "SiteNameLabel", attributes: { value: "SimpleTwitchBotJS (by DrewTheBear)", }, style: { fontFamily: "Open Sans Condensed", fontSize: "34px", padding: "2px 0px 0px 0px", color: "rgb(140, 140, 140)", display: "inline-flex", userSelect: "pointer", }, });
        ...
        githubIcon.content.onclick = () => { window.open("https://github.com/DrewBanyai/TwitchSimpleBotJS"); }
