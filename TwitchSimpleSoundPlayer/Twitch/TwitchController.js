...
class TwitchController {
    ...
    static async SendChatMessage(sendChannel, sendMessage, resend) {
    ...
    static handleTwitchMessage(message) {
        ...
        switch (message.event) {
            case "PING":                            if (message.channel === "tmi.twitch.tv") TwitchController.SendChatMessage("tmi.twitch.tv", "PONG", false);                 break;
            case "PONG":
            case "CAP":                 
            case "001":
            case "002":
