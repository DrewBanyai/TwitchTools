...
shutil.copy("Sounds.js", releaseFolder + "/Sounds.js")
shutil.copy("README.md", releaseFolder + "/README.md")
shutil.copy("CompileSounds.bat", releaseFolder + "/CompileSounds.bat")
